...
// drive strength flags, rwa edit
#define AD4630_OUTPUT_DRIVE_HI (0b01)
#define AD4630_OUTPUT_DRIVE_LO (0b00)
...
typedef enum
{
    ...
    AD4630_REG_OUTPUT_DRIVE = 0x22, // rwa edit
...
int configure_adc_to_output_host_clock()
{
    ...
    // rwa edit, control drive strength
     if ((res = ad4630_write_reg(AD4630_REG_OUTPUT_DRIVE, AD4630_OUTPUT_DRIVE_LO)) != E_NO_ERROR)
    {
        return res;
    }
...
int configure_data_spi_bus_to_receive_data_from_adc(mxc_spi_regs_t *hspi)
{
    ...
    if ((res = MXC_SPI_SetMode(hspi, SPI_MODE_2)) != E_NO_ERROR) // rwa edit, fix adc -> spi timing issue
       
    {
        return res;
    }

    debugRWA1 = hspi->ctrl2;
    debugRWA2 = 10;
